...
@section('content')
    ...
    <h1 class="mt-3 mb-3 text-center"> Add Post</h1>
    <div class="box" style="width: 60%; margin:0 auto">
        <form method="POST" action="{{url('admin/posts')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputSlug1"  name="slug">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="textForDescription" rows="3" name="description"></textarea>
            </div>

            <div class="form-group">
                <label for="textForMetaDescription">Meta Description</label>
                <textarea class="form-control" id="textForMetaDescription" rows="3" name="meta_description"></textarea>
            </div>

            <div class="form-group">
                <label for="textForMetaKeywords">Meta_Keywords</label>
                <textarea class="form-control" id="textForMetaKeywords" rows="3" name="meta_keywords"></textarea>
            </div>
